...
# 일일이 파일명 보면서 확인했는데 별로 유의한 느낌은 없다. 평균 51.414. 오르락내리락.
# 이거 코딩 잘못되서 실제로는 같은 곳에서 값 낮은 모델 뽑아서 체크함. 혹시나해서 작은게 계속 유지되나 싶었지만 그건 아닌것 같다. 하지만 textrmse는 눈여겨볼 필요가 있어보인 다.
#  10 fold textrmse: [25.927300564285154, 26.391284128092128, 12.353372189137643, 25.602475571145337, 12.810988025307427, 12.235275449781719, 26.283086941599677, 11.696391431110948, 25.571283971768874, 25.78803532868065]
# mean textrmse : 20.4659494
#  10 fold blendrmse: [43.898590087890625, 42.08753967285156, 38.13432312011719, 35.932918548583984, 65.83027648925781, 60.85215377807617, 41.904693603515625, 34.68014144897461, 58.27637481689453, 55.59443283081055]
# mean blendrmse : 47.7191444
